// MCP mark geometry from the project's official docs/favicon.svg:
// https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/docs/favicon.svg
export default function McpMark() {
  return (
    <svg width="22" height="22" viewBox="0 0 180 180" fill="none" stroke="currentColor" strokeWidth="11.0667" strokeLinecap="round" aria-hidden="true">
