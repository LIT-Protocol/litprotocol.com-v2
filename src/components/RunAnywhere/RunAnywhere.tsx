...
const RunAnywhere = ({ draft = false }: { draft?: boolean }) => (
  <section className="bg-coal-950 border-b border-white/5">
    <Container size="lg" className="!py-24 text-center">
      ...
      <p className="mt-5 max-w-[56ch] mx-auto text-white/65 text-lg leading-relaxed text-pretty">
        {draft
          ? 'Start with your application. Lit operates the confidential infrastructure. Bring your code, connect your data, and define what it can do. Start building with the crypto docs, or work with us to scope AI training and inference.'
